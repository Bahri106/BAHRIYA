/**
   * Recode By Saiful
   * Contact Me on wa.me/6285707645429
   * Follow https://github.com/Bahri106/BAHRIYA
   * JANGAN DIUBAH YA!! 
   * AWAS GUA BANTAI!!! 
*/
...
⭔ Url : ${anu.url}`,
		...
		let { pinterest } = require('./lib/scraper')
           ...
           case 'waifu': {
                m.reply(mess.wait)
                xavior.sendMessage(m.chat, { image: { url: 'https://xaviorapikey.herokuapp.com/api/wallpaper/waifu?apikey=APIKEY' }, caption: ' Subscribe XaviorOfc 👌' }, { quoted: m })
            }
            break
             case 'loli': {
                m.reply('mengloli...')
                xavior.sendMessage(m.chat, { image: { url: 'https://xaviorapikey.herokuapp.com/api/wallpaper/loli?apikey=APIKEY' }, caption: ' Subscribe XaviorOfc 👌' }, { quoted: m })
            }
            break
            case 'cosplay': {
                m.reply(mess.wait)
                xavior.sendMessage(m.chat, { image: { url: 'https://xaviorapikey.herokuapp.com/api/wallpaper/random/cosplay?apikey=APIKEY' }, caption: ' Subscribe XaviorOfc 👌' }, { quoted: m })
            }
            break
 ...
 *Note*: Chat Private Jika Ingin Meriview Kode` }, { quoted: m })
            ...
            case 'kodenuklir|0852': {
                ...
                xavior.sendMessage(m.chat, { image: { url: 'https://xaviorapikey.herokuapp.com/api/wallpaper/nsfwloli?apikey=APIKEY' }, caption: ' Subscribe XaviorOfc 👌' }, { quoted: m })
            }
            break
            case 'kodenuklir|1470': {
                m.reply('kode ahegao cuk')
                xavior.sendMessage(m.chat, { image: { url: 'https://xaviorapikey.herokuapp.com/api/nsfw/ahegao?apikey=APIKEY' }, caption: ' Subscribe XaviorOfc 👌' }, { quoted: m })
            }
            break
            
            case 'kodenuklir|1254': {
                m.reply('hmm sabar yah')
                xavior.sendMessage(m.chat, { image: { url: 'https://xaviorapikey.herokuapp.com/api/nsfw/ass?apikey=APIKEY' }, caption: ' Subscribe XaviorOfc 👌' }, { quoted: m })
            }
            break
            
             case 'kodenuklir|3690': {
                m.reply('teralu gege kodenya')
                xavior.sendMessage(m.chat, { image: { url: 'https://xaviorapikey.herokuapp.com/api/nsfw/bdsm?apikey=APIKEY' }, caption: ' Subscribe XaviorOfc 👌' }, { quoted: m })
            }
            break
...
⭔ Detail: ${detail}`
            ...
            case 'xaviorofc': {m.reply('*Babang XaviorOfc*')} break
          ...
          // Case Elite bos...
            ...
            let setbot = db.data.settings[botNumber]
               if (args[0] === 'templateImage'){
                ...
                xavior.sendListMsg(m.chat, `Please select the menu you want to change!`, '©XaviorOfc', `Halo Owner Xavior-Bot..!`, `Click Here`, sections, m)
                }
            }
            break
...
let btn = [{
            ...
            case 'menu': case 'help': case '?': {
                anu = `${ucapanWaktu} Bro👋\n\nSalken Nama Gua ${global.namabot}, Yang Piral Piral Itu Loh.\n\nKlo Gak Percaya Cari Aja Di Bawah Ini.\n\nKalau Lu gak Tau Caranya Tinggal Klik Tulisan *Yandex*`
                let btn = [{
                                urlButton: {
                                    displayText: 'Video Piral🗿',
                                    url: 'https://youtube.com/channel/UCadk5BwVWzj-r_x0JGwZMRg'
                                }
                                }, {
                                urlButton: {
                                    displayText: 'Website Arachu',
                                    url: 'https://xaviorofc.mystrikingly.com'
                                }
                            }, {
                                quickReplyButton: {
...
🤖 : Script Gak Dijual, Tapi Bisa Cari Di YT XaviorOfc
